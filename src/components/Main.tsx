...
const Main = () => {
  return (
    <div className="w-full h-full flex-row rows-3">
      ...
      <h3 className="text-2xl w-[400px] rounded-lg p-3 alfa-slab text-center mx-auto bg-purple-600 text-white mb-8">NOTICIES</h3>
      <section className="w-full h-full flex justify-center">
        <Noticies />
      </section>
      <h3 className="text-2xl w-[400px] rounded-lg p-3 alfa-slab mt-4 text-center mx-auto bg-purple-600 text-black mb-8">GATS EN ADOPCIÓ</h3>
      <section className="w-full h-full md:flex justify-between gap-3">
      ...
      <h3 className="text-2xl w-[400px] rounded-lg p-3 alfa-slab mt-4 text-center mx-auto bg-purple-600 text-black mb-8">DONACIONS</h3>
      <section>
      ...
      <footer className="w-full flex flex-col sm:flex-col lg:flex-row items-center md:justify-around h-25 pt-2 bg-purple-800">
        <p className="text-black font-bold text-2xl lobster pb-3">Amics dels Gats i d'altres Animals de Balenyà</p>
